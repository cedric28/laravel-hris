				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							<a type="button" style="box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12);" href="{{ route('user.create')}}" class="btn btn-outline-success btn-sm float-left"><i class="fas fa-users mr-2"></i> Add User</a>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-four-tabContent">
                                        <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                            <table class="table table-hover table-striped" style="box-shadow: 1px 16px 20px 0px rgba(19,54,30,0.75);"id="users">
                                                <thead>
                                        ...
                                        <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab"> 
                                            <table class="table table-hover table-striped" style="box-shadow: 1px 16px 20px 0px rgba(19,54,30,0.75);"id="inactive-users">
                                                <thead>
                                                    <tr style="text-align:center;">
                                                        <th>FIRSTNAME</th>
                                                        <th>LASTNAME</th>
                ...
                "buttons": [
                    {
                        ...
                        "buttons": [{
                            extend: 'csv',
                            filename: 'List of Users as of <?= date('F j, Y') ?>',
                            exportOptions: {
                                columns: [0, 1, 2, 3, 4]
                            },
                            customize: function(csv) {
                                ...
                                var headerLines = [
                                    ...
                                    'List of Users as of <?= date('F j, Y') ?>',
                                    ''
                                ].join('\n');
                            ...
                            },
                            {
                                ...
                                filename: 'List of Users as of {{ \Carbon\Carbon::now()->toFormattedDateString() }}',
                                customize: function(doc) {
                                    ...
                                    doc.content.unshift({
                                        text: 'List of Users as of {{ \Carbon\Carbon::now()->toFormattedDateString() }}',
                                        alignment: 'left',
                                        fontSize: 12,
                                        bold: true,
                                        margin: [0, 0, 0, 10]
                            ...
                            {
                                "extend": 'print',
                                "title": 'List of Users as of <?= date('F j, Y') ?>',
                                "exportOptions": {
                                    "columns": [0, 1, 2, 3, 4]
                                },
                ...
                "buttons": [
                    {
                        ...
                        "buttons": [{
                            extend: 'csv',
                            filename: 'List of Inactive Users as of <?= date('F j, Y') ?>',
                            exportOptions: {
                                columns: [0, 1, 2, 3, 4]
                            },
                            customize: function(csv) {
                                ...
                                var headerLines = [
                                    ...
                                    'List of Inactive Users as of <?= date('F j, Y') ?>',
                                    ''
                                ].join('\n');
                            ...
                            },
                            {
                                ...
                                filename: 'List of Inactive Users as of {{ \Carbon\Carbon::now()->toFormattedDateString() }}',
                                customize: function(doc) {
                                    doc.pageMargins = [40, 160, 40,
                                        60
                                    ];
                                    ...
                                    doc.styles.tableHeader.fontSize = 10;
                                    doc.content.unshift({
                                        text: 'List of Inactive Users as of {{ \Carbon\Carbon::now()->toFormattedDateString() }}',
                                        alignment: 'left',
                                        fontSize: 12,
                                        bold: true,
                                        margin: [0, 0, 0, 10]
                            ...
                            {
                                "extend": 'print',
                                "title": 'List of Inactive Users as of <?= date('F j, Y') ?>',
                                "exportOptions": {
                                    "columns": [0, 1, 2, 3, 4]
                                },
                                customize: function(win) {
