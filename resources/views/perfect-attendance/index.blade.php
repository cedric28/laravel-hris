                ...
                "buttons": [
                    {
                        ...
                        "buttons": [{
                            extend: 'csv',
                            filename: 'List of Employees with Perfect Attendance as of <?= date('F j, Y') ?>',
                            exportOptions: {
                                columns: [0, 1]
                            },
                            customize: function(csv) {
                                ...
                                var headerLines = [
                                    ...
                                    'List of Employees with Perfect Attendance as of <?= date('F j, Y') ?>',
                                    ''
                                ].join('\n');
                            ...
                            },
                            {
                                ...
                                filename: 'List of Employees with Perfect Attendance as of {{ \Carbon\Carbon::now()->toFormattedDateString() }}',
                                customize: function(doc) {
                                    ...
                                    doc.content.unshift({
                                        text: 'List of Employees with Perfect Attendance as of {{ \Carbon\Carbon::now()->toFormattedDateString() }}',
                                        alignment: 'left',
                                        fontSize: 12,
                                        bold: true,
                                        margin: [0, 0, 0, 10]
                            ...
                            {
                                "extend": 'print',
                                "title": 'List of Employees with Perfect Attendance as of <?= date('F j, Y') ?>',
                                "exportOptions": {
                                    "columns": [0, 1]
                                },
