				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
                            ...
                            <a type="button" style="box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12);" href="{{ route('overtime.edit', $deployment->id )}}" class="btn bg-gradient-success float-right"><i class="fas fa-clock mr-2"></i> File Overtime</a>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
