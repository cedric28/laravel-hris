							...
							<div class="col-lg-9">	
								<select name="always_on_time" class="form-control">
									...
									@foreach ($always_on_time as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('always_on_time', $feedback->always_on_time)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="prompt_and_on_time" class="form-control">
									...
									@foreach ($prompt_and_on_time as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('prompt_and_on_time', $feedback->prompt_and_on_time)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="adheres_to_the_schedule" class="form-control">
									...
									@foreach ($adheres_to_the_schedule as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('adheres_to_the_schedule', $feedback->adheres_to_the_schedule)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="very_reliable_at_work" class="form-control">
									...
									@foreach ($very_reliable_at_work as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('very_reliable_at_work', $feedback->very_reliable_at_work)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="inspires_others_to_improve_attendance" class="form-control">
									...
									@foreach ($inspires_others_to_improve_attendance as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('inspires_others_to_improve_attendance', $feedback->inspires_others_to_improve_attendance)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="is_frequently_late_to_work" class="form-control">
									...
									@foreach ($is_frequently_late_to_work as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('is_frequently_late_to_work', $feedback->is_frequently_late_to_work)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="unreliable_about_reporting" class="form-control">
									...
									@foreach ($unreliable_about_reporting as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('unreliable_about_reporting', $feedback->unreliable_about_reporting)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="unwilling_to_work_beyond_scheduled_hours" class="form-control">
									...
									@foreach ($unwilling_to_work_beyond_scheduled_hours as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('unwilling_to_work_beyond_scheduled_hours', $feedback->unwilling_to_work_beyond_scheduled_hours)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="not_a_dependable_employee" class="form-control">
									...
									@foreach ($not_a_dependable_employee as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('not_a_dependable_employee', $feedback->not_a_dependable_employee)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="work_results_are_inconsistent" class="form-control">
									...
									@foreach ($work_results_are_inconsistent as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('work_results_are_inconsistent', $feedback->work_results_are_inconsistent)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
							...
							<div class="col-lg-9">	
								<select name="rate" class="form-control">
									...
									@foreach ($rate as $always)
										<option value="{{ $always['name'] }}" {{ $always['name'] == old('rate', $feedback->rate)  ? ' selected' : '' }}>
											{{ $always['name'] }}
										</option>
									@endforeach
								</select>
