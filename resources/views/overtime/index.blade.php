				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							...
							<div class="row">
								<h3 class="card-title">Bulk Over-Time Form <a class="ml-2 btn btn-primary" 
style="box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12);" href="{{ route('downloadOverTimeFile') }}" target="_blank"> <i class="nav-icon fas fa-file-excel"></i> Download OverTime Template</a></h3>
							</div>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
